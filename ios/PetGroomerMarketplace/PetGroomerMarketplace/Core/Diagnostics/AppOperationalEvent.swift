...
final class AppOperationalEventFileWriter: AppOperationalEventWriting {
    ...
    init(
        ...
        fileURL = (directoryURL ?? supportURL.appendingPathComponent("GroomlyOperational", isDirectory: true))
...
final class AppOperationalEventRecorder {
    ...
    private enum DefaultsKey {
        static let runID = "groomly.operational.currentRunID"
        static let runState = "groomly.operational.currentRunState"
        static let updatedAt = "groomly.operational.currentRunUpdatedAt"
    }
