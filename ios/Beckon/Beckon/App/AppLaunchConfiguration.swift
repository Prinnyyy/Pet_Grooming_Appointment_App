...
struct AppTestOpsConfiguration: Equatable, Sendable {
    static let runIDArgument = "--beckon-testops-run-id"
    static let scenarioArgument = "--beckon-testops-scenario"
    static let clearSessionArgument = "--beckon-testops-clear-session"
    static let disableAnimationsArgument = "--beckon-testops-disable-animations"
