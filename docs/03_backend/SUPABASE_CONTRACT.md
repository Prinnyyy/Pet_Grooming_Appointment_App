...
- T-067 extends completed-booking reviews with structured outcomes while preserving the existing rating/content contract. It does not add iOS UI or evidence summary views.
