...
- Local migration mirror: `../../supabase/migrations/` is the append-only source for applied and prepared migrations. Local migration mirror count: 59 files. Do not rename or hand-invent migration filenames.
