...
| Groomer profile/services/portfolio/availability | read marketplace-safe active profile/service/portfolio data only | manage own profile, services, portfolio, availability rows, full base address fields, and profile avatar path/object | Verification/rating summary denied to client; availability is not customer-readable yet; broader customer-facing avatar presentation remains deferred |
