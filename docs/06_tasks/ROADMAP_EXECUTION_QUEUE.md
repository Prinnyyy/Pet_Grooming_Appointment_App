...
|---|---|---|---|
| Q-122 | R-042 | Request Wizard input and time semantics | Ready. Service choice is explicit, Custom Request requires useful detail, dates beyond the seven-day quick strip are reachable, and Continue has one truthful visual/interaction state with field-level validation. |
...
Q-122 is the next selectable package after T-358 completed Q-121. Completed package evidence is preserved in `../09_frozen/roadmaps/T-346_2026-07-13/`, task-ledger archives, worklogs, and durable decisions.
