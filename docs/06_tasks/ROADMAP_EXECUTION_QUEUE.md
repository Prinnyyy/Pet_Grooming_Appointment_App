...
|---|---|---|---|
| Q-123 | R-042 | Request photo selection and retry | Ready. Request-specific photos have preview, removal, review-summary, and post-create retry behavior while remaining distinct from the Pet avatar snapshot. |
...
Q-123 is the next selectable package after T-359 completed Q-122. Completed package evidence is preserved in `../09_frozen/roadmaps/T-346_2026-07-13/`, task-ledger archives, worklogs, and durable decisions.
