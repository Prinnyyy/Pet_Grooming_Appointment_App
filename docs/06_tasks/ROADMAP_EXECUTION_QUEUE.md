...
|---|---|---|---|
| Q-124 | R-042 | Offer confirmation and Booking handoff | Ready. Acceptance presents groomer/time/price/location/cancellation context, blocks duplicate submission, removes backend jargon, and routes directly to the resulting Booking. |
