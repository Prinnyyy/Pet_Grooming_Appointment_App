...
| M14 UI consistency governance | Make visual consistency code-defined, reusable, and automatically auditable. | Design T-301 approved; implementation planning pending. | Four Customer reference surfaces use semantic foundations/components, all Feature code blocks new visual debt, and remaining debt is explicit. |
...
| R-041 | M14 | Code-enforced UI consistency and Customer reference migration | Design T-301 approved in `../superpowers/specs/2026-07-12-ui-consistency-governance-design.md`; execution packages pending implementation plan |
...
Execution sequencing: prepare the R-041 implementation plan before assigning its packages. Q-104 remains deferred until the user restores its Groomer Dynamic Type/Accessibility scope; Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
