...
| M11 Beckon identity | Replace the Groomly/PetGroomerMarketplace identity across active local and remote surfaces. | Design complete T-243; Q-94 through Q-96 queued. | Approved Beckon identity is consistent in app/source/workflow/remote state and full regression evidence passes. |
...
| R-038 | M11 | Complete Beckon brand and technical identity migration | Design complete T-243; Q-94 through Q-96 queued in dependency order |
...
Execution sequencing: use `ROADMAP_EXECUTION_QUEUE.md` to select the next dependency-satisfied package. Each adopted package receives the next `T-###`. Q-94 is next; Q-95/Q-96 follow in order. Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
