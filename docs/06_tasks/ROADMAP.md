...
T-301 adopts R-041 through `../superpowers/specs/2026-07-12-ui-consistency-governance-design.md`; T-303 defines Q-113 through Q-120 in `../superpowers/plans/2026-07-12-ui-consistency-governance-implementation.md`; T-304 completes Q-113's tested source-audit debt ratchet and preflight gate. Beckon's existing DesignSystem remains the single implementation source.

The first migration slice is Customer Home, Requests, Request creation, and Account plus their directly used DesignSystem primitives. T-304 places Feature code under the Q-113 audit baseline, T-305 adds Q-114's semantic token/contrast foundation, and T-307 adds Q-115's shared semantic components/catalog. Non-slice legacy debt remains recorded rather than forcing a whole-app rewrite. Q-116 through Q-120 preserve business logic, repositories, navigation, backend contracts, dependencies, and the separately deferred Groomer Q-104 scope.
...
| M14 UI consistency governance | Make visual consistency code-defined, reusable, and automatically auditable. | Foundations Q-113...Q-115 complete through T-307; Q-116 through Q-120 queued. | Four Customer reference surfaces use semantic foundations/components, all Feature code blocks new visual debt, and remaining debt is explicit. |
...
| R-041 | M14 | Code-enforced UI consistency and Customer reference migration | Foundations Q-113...Q-115 complete through T-307; execute Q-116 through Q-120 in order |
...
Execution sequencing: continue R-041 with Q-116 through Q-120 in order. Q-104 remains deferred until the user restores its Groomer Dynamic Type/Accessibility scope; Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
