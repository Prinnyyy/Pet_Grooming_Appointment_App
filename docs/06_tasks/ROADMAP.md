...
| R-037 | M4 | Foreground refresh concurrency test determinism | Ready Q-43 after T-240 meta-review observed one standard-suite scheduling failure followed by a focused pass |
...
Execution sequencing: use `ROADMAP_EXECUTION_QUEUE.md` to select the next dependency-satisfied package. Each adopted package receives the next `T-###`. Q-43 is the only executable package. Q-90/Q-91 remain excluded, while Q-92/Q-93 remain externally blocked.
