...
| M8 Ideal operation verification | Prove the local V1.0 lifecycle end to end. | Q-32 complete T-221; planned Q-33. | Dual-role walkthrough evidence and readiness dry run pass. |
