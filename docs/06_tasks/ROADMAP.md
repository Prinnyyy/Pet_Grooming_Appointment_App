...
The first migration slice is Customer Home, Requests, Request creation, and Account plus their directly used DesignSystem primitives. Q-113...Q-115 establish the audit/tokens/components, and T-308/Q-116 migrates Customer Home with separate Pet Form ownership. Non-slice legacy debt remains recorded rather than forcing a whole-app rewrite. Q-117 through Q-120 preserve business logic, repositories, navigation, backend contracts, dependencies, and the separately deferred Groomer Q-104 scope.
...
| M14 UI consistency governance | Make visual consistency code-defined, reusable, and automatically auditable. | Foundations Q-113...Q-115 and Customer Home Q-116/T-308 complete; Q-117 through Q-120 queued. | Four Customer reference surfaces use semantic foundations/components, all Feature code blocks new visual debt, and remaining debt is explicit. |
...
| R-041 | M14 | Code-enforced UI consistency and Customer reference migration | Q-113...Q-116 complete through T-308; execute Q-117 through Q-120 in order |
...
Execution sequencing: continue R-041 with Q-117 through Q-120 in order. Q-104 remains deferred until the user restores its Groomer Dynamic Type/Accessibility scope; Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
