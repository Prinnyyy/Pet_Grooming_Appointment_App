...
| M11 Beckon identity | Replace the legacy brand/project identity across active local and remote surfaces. | Q-94/T-246 and Q-95/T-247 complete; Q-96 remains remote-write gated. | Approved Beckon identity is consistent in app/source/workflow/remote state and full regression evidence passes. |
...
| R-038 | M11 | Complete Beckon brand and technical identity migration | Design T-243, local Q-94/T-246, and workflow Q-95/T-247 complete; Q-96 awaits fresh remote authorization |
...
Execution sequencing: use `ROADMAP_EXECUTION_QUEUE.md` to select the next dependency-satisfied package. Each adopted package receives the next `T-###`. Q-96 is next only after fresh remote authorization. Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
