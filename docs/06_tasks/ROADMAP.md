...
| M6 Free-mode timeliness | Make local/foreground updates symmetric without APNs. | Q-16 and Q-17 complete; Q-18 through Q-22 planned. | Groomer/customer notifications, foreground refresh, local reminders, and unread badges are covered. |
...
Completed mapping: T-152/T-154/T-188...T-193 M1; T-153/T-155/T-156/T-162/T-194 M2; T-157 M2 blocked for dispatch; T-160/T-161/T-195/T-197...T-199 M3; T-200 M4; T-201 M5 local dry run; T-203...T-204 M6 groomer notification prep/UI; T-163...T-179 G0.

Execution sequencing: use `ROADMAP_EXECUTION_QUEUE.md` to select the next adoptable package. The queue is planning input only; each adopted package receives the next `T-###` from `TASK_LEDGER.md`. Active V1.0 ideal-operation sequencing continues at Q-18.
