...
Q-97/T-250, Q-98/T-252, and Q-99/T-253 are complete; Q-100 through Q-104 remain local iOS packages. They preserve existing repositories, marketplace state transitions, authenticated images, feedback, pagination, accessibility, and TestOps behavior. No Supabase migration, remote write, dependency, or deferred product feature is included.
...
| M12 Groomer workspace | Make Groomer operationally clear while preserving the shared Beckon product language. | Design T-249, Q-97/T-250, Q-98/T-252, and Q-99/T-253 complete; Q-100 through Q-104 queued. | Five direct tabs, approved screen hierarchy, focused editors, selector-based regressions, and compact/large viewport QA pass. |
