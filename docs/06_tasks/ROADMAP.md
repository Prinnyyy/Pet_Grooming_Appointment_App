...
| M11 Beckon identity | Replace the legacy brand/project identity across active local and remote surfaces. | Q-94 complete T-246; Q-95/Q-96 remain. | Approved Beckon identity is consistent in app/source/workflow/remote state and full regression evidence passes. |
...
| R-038 | M11 | Complete Beckon brand and technical identity migration | Design T-243 and local Q-94/T-246 complete; Q-95/Q-96 remain in dependency order |
...
Execution sequencing: use `ROADMAP_EXECUTION_QUEUE.md` to select the next dependency-satisfied package. Each adopted package receives the next `T-###`. Q-95 is next; Q-96 follows after the standalone workflow task and fresh remote authorization. Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
