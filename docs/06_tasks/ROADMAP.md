...
| M4 Quality expansion | Make tests/checks systematic. | T-165/T-168 started docs/preflight coverage; T-200 closes focused Store/state coverage; T-206/T-208/T-214 close offer, notification, and decode/cache tolerance coverage. | Required checks are documented, runnable, and task-typed. |
...
| M7 Structural and edge resilience | Reduce oversized surfaces and close edge-case gaps. | Q-23 through Q-27 complete; planned Q-28 through Q-31. | Request/profile surfaces are split, republish/pagination/auth edges are tested, and unit coverage increases. |
...
| R-027 | M7 | Recovery, auth callback, and pagination robustness | Q-27 complete T-215; planned Q-29, Q-30 |
| R-028 | M4/M7 | Focused unit and contract test expansion toward 400 tests | Q-19 complete T-206; Q-20 complete T-208; Q-25 complete T-213; Q-26 complete T-214; planned Q-28, Q-31 |
...
Completed mapping: T-152/T-154/T-188...T-193 M1; T-153/T-155/T-156/T-162/T-194 M2; T-157 M2 blocked for dispatch; T-160/T-161/T-195/T-197...T-199 M3; T-200/T-206/T-208/T-213/T-214 M4 focused tests; T-201 M5 local dry run; T-203...T-205/T-209/T-210 M6 groomer notification, foreground refresh, local reminders, and unread badges; T-211/T-212/T-214/T-215 M7 request/profile splits, decode/cache tolerance, and republish hardening; T-163...T-179/T-207 G0.

Execution sequencing: use `ROADMAP_EXECUTION_QUEUE.md` to select the next adoptable package. The queue is planning input only; each adopted package receives the next `T-###` from `TASK_LEDGER.md`. Active V1.0 ideal-operation sequencing continues at Q-28.
