...
Execution sequencing: use `ROADMAP_EXECUTION_QUEUE.md` to select the next dependency-satisfied package. Each adopted package receives the next `T-###`; none is currently ready. Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
