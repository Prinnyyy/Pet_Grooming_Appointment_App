...
The first migration slice is Customer Home, Requests, Request creation, and Account plus their directly used DesignSystem primitives. T-304 places all Feature code under the Q-113 audit baseline; non-slice legacy debt remains recorded rather than forcing a whole-app rewrite. Q-114 through Q-120 preserve business logic, repositories, navigation, backend contracts, dependencies, and the separately deferred Groomer Q-104 scope.
...
| M14 UI consistency governance | Make visual consistency code-defined, reusable, and automatically auditable. | Design T-301, plan T-303, and Q-113/T-304 complete; Q-114 through Q-120 queued. | Four Customer reference surfaces use semantic foundations/components, all Feature code blocks new visual debt, and remaining debt is explicit. |
...
| R-041 | M14 | Code-enforced UI consistency and Customer reference migration | Design T-301, plan T-303, and Q-113/T-304 complete; execute Q-114 through Q-120 in order |
...
Execution sequencing: continue R-041 with Q-114 through Q-120 in order. Q-104 remains deferred until the user restores its Groomer Dynamic Type/Accessibility scope; Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
