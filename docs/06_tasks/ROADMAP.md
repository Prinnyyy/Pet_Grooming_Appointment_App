...
The first migration slice is Customer Home, Requests, Request creation, and Account plus their directly used DesignSystem primitives. Q-113...Q-115 establish the audit/tokens/components; T-308/Q-116 through T-311/Q-119 migrate the four Customer references. Non-slice legacy debt remains recorded rather than forcing a whole-app rewrite. Q-120 verifies the slice without changing business logic, repositories, navigation, backend contracts, dependencies, or the separately deferred Groomer Q-104 scope.
...
| M14 UI consistency governance | Make visual consistency code-defined, reusable, and automatically auditable. | Q-113...Q-119 complete through T-311; Q-120 integration gate queued. | Four Customer reference surfaces use semantic foundations/components, all Feature code blocks new visual debt, and remaining debt is explicit. |
...
| R-041 | M14 | Code-enforced UI consistency and Customer reference migration | Q-113...Q-119 complete through T-311; execute Q-120 integration gate |
...
Execution sequencing: complete R-041 with Q-120. Q-104 remains deferred until the user restores its Groomer Dynamic Type/Accessibility scope; Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
