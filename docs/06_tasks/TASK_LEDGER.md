...
Current branch and task-numbering baseline: use `codex/pet-fit-structure-cleanup`; use `T-346` for the next new task. T-345 is completed, and T-340 remains separately planned.
...
Pre-reset source snapshot: `docs/09_frozen/active_state_snapshots/T-345_2026-07-13/TASK_LEDGER.md`. Removed T-332 through T-338 rows: `docs/09_frozen/task_ledgers/TASK_LEDGER_T-332_TO_T-338_2026-07-13.md`.
