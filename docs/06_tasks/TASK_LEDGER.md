...
Current branch and task-numbering baseline: use `codex/pet-fit-structure-cleanup`; use `T-349` for the next new task. T-348 is completed, and T-340 remains separately planned.
