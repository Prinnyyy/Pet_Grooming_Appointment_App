...
- `T-063` through `T-071`: pet-fit matching contract, taxonomy, SQL helpers, groomer/review evidence input, evidence summary, backend match scoring, iOS fit-reason surfacing, and availability enforcement.
