...
- `T-063` through `T-070`: pet-fit matching contract, taxonomy, SQL helpers, groomer/review evidence input, evidence summary, backend match scoring, and iOS fit-reason surfacing.
