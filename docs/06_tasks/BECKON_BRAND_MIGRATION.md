...
1. Q-94 performs the local application/source rename and prepares append-only backend changes. It must pass the complete local iOS, TestOps, migration, privacy, and context gates before remote work.
