...
| Customer pets and photos | `SCREEN_INVENTORY.md`, `UX_RULES.md` | `DATA_FLOW.md`, `MODULE_BOUNDARIES.md` | `SUPABASE_CONTRACT.md`, `STORAGE_POLICY.md`, `RLS_RPC_POLICY.md` | planned `Features/Pets/` | T-008 backend complete; iOS CRUD and actual Storage API upload/delete planned | T-008–T-009 |
