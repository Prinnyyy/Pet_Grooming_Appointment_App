...
| Groomer profile, services, and portfolio | `USER_ROLES.md`, `SCREEN_INVENTORY.md` | `MODULE_BOUNDARIES.md` | `SUPABASE_CONTRACT.md`, `STORAGE_POLICY.md`, `RLS_RPC_POLICY.md` | planned Groomer profile feature | Backend complete; iOS UI planned | T-010–T-011 |
