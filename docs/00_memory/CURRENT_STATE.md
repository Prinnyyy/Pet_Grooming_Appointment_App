...
- Date: 2026-07-12
- Updated by: Codex
- Latest completed task: T-319 minimum keyboard-avoidance redesign plan.
- Current task: none; T-157 APNs remains externally blocked and Q-104 Dynamic Type/Accessibility remains user-deferred.
- Next task ID: use T-320 for the selected minimum-reveal algorithm and Request reference migration. T-321...T-323 migrate the remaining input surfaces; Groomer Q-104 remains deferred.
