...
- Date: 2026-07-14
- Latest completed task: T-354 Shared Customer/Groomer Messages presentation.
- Current task: none.
- Next task ID: T-355 for the next new task.
...
- Latest app validation: T-354 passed 30 focused Chat tests, the complete iOS suite, and `./scripts/ios-build.sh`.
- Latest full iOS regression: T-354 passed the complete iOS suite and build.
...
- Customer and Groomer Messages use one conversation-page title and card-row presentation; thread, bubble, composer, Store, repository, pagination, unread, and role-routing behavior remain shared or role-aware behind the same Chat feature boundary.
