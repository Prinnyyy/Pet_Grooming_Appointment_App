...
- Date: 2026-07-11
- Updated by: Codex
- Latest completed task: T-266 customer request-card avatar proportion and alignment.
- Current task: none; T-157 APNs remains externally blocked and Q-104 Dynamic Type/Accessibility remains user-deferred.
- Next task ID: use T-267. Q-104 remains deferred until the user restores its Dynamic Type/Accessibility scope.
