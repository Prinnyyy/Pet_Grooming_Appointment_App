...
- [ ] Replace the local filled primary action with a compact white surface action using sampled Display P3 `#518B7F` foreground, reference-calibrated rounded typography, and unchanged disabled semantics.
