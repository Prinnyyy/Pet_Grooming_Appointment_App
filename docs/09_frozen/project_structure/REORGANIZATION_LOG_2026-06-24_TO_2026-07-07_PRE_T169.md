...
## 2026-07-07 - T-168 Rolling Archives

| Active source | Frozen path | Reason |
|---|---|---|
| `docs/06_tasks/TASK_LEDGER.md` row T-153 | `docs/09_frozen/task_ledgers/TASK_LEDGER_T-153_2026-07-07.md` | Keep active ledger under the 15-row window after adding T-168. |
| `docs/00_memory/WORKLOG.md` entry T-157 APNs credential note | `docs/09_frozen/worklogs/WORKLOG_2026-07-07_T-157_APNS_CREDENTIAL_NOTE.md` | Keep active worklog under the 10-entry window after adding T-168. |

## 2026-07-07 - T-167 Roadmap Worklog Archive

| Active source | Frozen path | Reason |
|---|---|---|
| `docs/00_memory/WORKLOG.md` entry T-158 | `docs/09_frozen/worklogs/WORKLOG_2026-07-07_T-158.md` | Keep the active worklog under the hygiene 10-entry window after adding T-167. |
