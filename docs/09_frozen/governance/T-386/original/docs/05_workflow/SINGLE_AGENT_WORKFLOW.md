...
Closeout handles the selected task's artifacts only. Valid active plans/specs owned by another ledger-listed planned, active, or blocked task remain unchanged with their backlinks; they do not block the selected task. Unknown owners or completed leftovers still fail validation.
