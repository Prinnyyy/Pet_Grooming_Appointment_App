...
The first migration slice is Customer Home, Requests, Request creation, and Account plus their directly used DesignSystem primitives. Q-113...Q-115 establish the audit/tokens/components; T-308/Q-116 through T-311/Q-119 migrate the four Customer references; T-312/Q-120 completes the strict/full-regression/default-and-Accessibility-3 integration gate and publishes `../04_ios/UI_CONSISTENCY_DEBT.md`. Non-slice legacy debt remains recorded rather than forcing a whole-app rewrite. Business logic, repositories, navigation, backend contracts, dependencies, and the separately deferred Groomer Q-104 scope are unchanged.
...
| M14 UI consistency governance | Make visual consistency code-defined, reusable, and automatically auditable. | Complete Q-113...Q-120 through T-312. | Four Customer reference surfaces use semantic foundations/components, all Feature code blocks new visual debt, and remaining debt is explicit. |
...
| R-041 | M14 | Code-enforced UI consistency and Customer reference migration | Complete Q-113...Q-120 through T-312 |
...
Execution sequencing: R-041 is complete. Q-104 remains deferred until the user restores its Groomer Dynamic Type/Accessibility scope; Q-90/Q-91 remain excluded, Q-92 is complete, and Q-93 remains externally blocked.
