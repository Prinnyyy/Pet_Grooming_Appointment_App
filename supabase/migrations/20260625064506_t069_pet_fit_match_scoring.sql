...
comment on function public.create_grooming_request(
  ...
  'Creates a fixed-service customer grooming request and creates eligible groomer matches with location and bounded pet-fit evidence scoring.';
