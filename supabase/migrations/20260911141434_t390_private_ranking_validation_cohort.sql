-- Scoped rollout uses the same ranking implementation after normal authorization.
alter table app_private.match_ranking_config add column validation_actor_ids uuid[] not null default '{}'
  check (array_position(validation_actor_ids,null) is null);
