-- T-012 corrective draft.
-- Authorized target: lqmasbuqzvcvtawonjlb only.
-- Purpose: remove PL/pgSQL ambiguity between the function output column
-- `request_id` and the request_matches table column in the ON CONFLICT target.
