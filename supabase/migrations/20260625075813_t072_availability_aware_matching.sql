-- T-072 availability-aware request matching.
...
begin
  ...
  select
    ...
    left(
      case
        when pet_fit.reason_text is null then
...
comment on function public.create_grooming_request(
  ...
  'Creates a fixed-service customer grooming request and creates eligible availability-aware groomer matches with location and bounded pet-fit evidence scoring.';
