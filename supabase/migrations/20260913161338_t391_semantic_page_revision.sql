-- T-391 / V-01. Soft refresh bookkeeping is not a change to the ranked page.
-- Keep hard source revisions/events, visible evidence, sort keys and eligibility checks.
